# Contributing to Detrudr

First off, thank you for considering contributing to Detrudr! It's people like you that make the
...
[Detrudr Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this
...
[Issues](https://github.com/DetrudrHQ/detrudr/issues) that might help you. It is also advisable to
...
- Checkout the issues template [here](.github/ISSUE_TEMPLATE/bug_report.md). It should serve as your
  guide.

- Open an [Issue](https://github.com/DetrudrHQ/detrudr/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are
  ...
  [bug tracker](https://github.com/DetrudrHQ/detrudr/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/DetrudrHQ/detrudr/issues/new). (Since we can't be sure at this
  point whether it is a bug or not, we ask you not to blanket-label the issue yet).
...
This section guides you through submitting an enhancement suggestion for Detrudr, including
...
- Search [Issues](https://github.com/DetrudrHQ/detrudr/issues) to see if the enhancement has already
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/detrudr/detrudr/issues).
The [feature request template](.github/ISSUE_TEMPLATE/feature_request.md) will be of help.

- Open an [Issue](https://github.com/detrudr/detrudr/issues/new).
...
- **Explain why this enhancement would be useful** to most Detrudr users. You may also want to point
